...
- [ ] Update dependencies: Next.js 15.5.6, React 19, Zustand 5.0.8, add RHF/Zod/TanStack Table, Tailwind 4, DaisyUI
- [ ] Create 'MedSource Classic' DaisyUI theme with brand colors (#416706, #4d7a07, teal)
- [ ] Restructure project: Create app/_components, _services, _stores, _hooks folders with underscore prefix
