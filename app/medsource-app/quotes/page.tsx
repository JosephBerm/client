...
export default function QuotesPage() {
    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <Link
            href={`/medsource-app/quotes/${row.original.id}`}
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="flex gap-2">
            <Link href={`/medsource-app/quotes/${row.original.id}`}>
  ...
  return (
    <ClientPageLayout title="Quotes" description="Manage customer quote requests">
