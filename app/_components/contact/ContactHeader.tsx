...
export default function ContactHeader() {
	...
	return (
		<header
			...
			className={classNames('text-center mb-12 md:mb-16 lg:mb-20 transition-all duration-700', {
			...
			<Pill
				...
				icon={
					<StatusDot
						variant={isOpen ? 'success' : 'primary'}
						size='sm'
						animated={isOpen}
					/>
				}
			...
			<p className='text-base md:text-lg text-base-content/70 max-w-3xl mx-auto mb-8'>
				Whether you need a product quote, have questions about our services, or want to discuss your
			...
			<div className='flex flex-wrap items-center justify-center gap-6 md:gap-8 mt-8'>
				<div className='flex items-center gap-2 text-sm text-base-content/70'>
					<Clock
						...
						aria-hidden='true'
					/>
					<span className='font-medium'>{COMPANY_CONTACT.responseTime.standard} response time</span>
				</div>
				<div className='flex items-center gap-2 text-sm text-base-content/70'>
					<Headphones
						className='h-4 w-4 text-primary'
						aria-hidden='true'
					/>
					<span className='font-medium'>{COMPANY_CONTACT.responseTime.emergency} support available</span>
				</div>
				<div className='flex items-center gap-2 text-sm text-base-content/70'>
					<Shield
						className='h-4 w-4 text-primary'
