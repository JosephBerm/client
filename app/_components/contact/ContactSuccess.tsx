			...
			<Card
				...
				<div className='flex flex-col items-center space-y-6'>
					...
					<div className='relative'>
						<div
							className='absolute inset-0 rounded-full bg-success/20 blur-2xl animate-pulse'
							aria-hidden='true'
						/>
						<CheckCircle
							className='relative w-20 h-20 md:w-24 md:h-24 text-success'
							aria-hidden='true'
						/>
					</div>
					...
					<div className='space-y-4'>
						<h2 className='text-3xl md:text-4xl font-semibold text-base-content'>Contact Request Sent!</h2>
						...
						<p className='text-base md:text-lg text-base-content/70 max-w-xl mx-auto'>
							...
							<span className='font-semibold text-primary'>{COMPANY_CONTACT.responseTime.standard}</span>{' '}
