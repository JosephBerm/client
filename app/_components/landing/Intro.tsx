	...
	return (
		<section id="hero" className="relative overflow-hidden bg-base-100">
			...
			<PageContainer className="relative grid gap-16 py-20 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-start xl:gap-24">
				...
				<span className="badge badge-lg badge-primary gap-2 px-4 py-3 text-[0.7rem] font-semibold uppercase tracking-[0.4em] shadow-sm">
					<span className="h-2 w-2 rounded-full bg-primary-content" />
					Medical supply specialists
				</span>

				<header className="space-y-4 text-left">
					<h1 className="text-4xl font-extrabold leading-[1.05] text-primary sm:text-5xl lg:text-[3.75rem]">
				...
				<div className="relative overflow-hidden rounded-[32px] border border-base-300 bg-base-200 shadow-2xl">
					...
					<div className="badge badge-primary absolute bottom-6 left-6 flex items-center gap-3 px-6 py-3 text-[0.7rem] font-semibold uppercase tracking-[0.35em] shadow-lg backdrop-blur">
						<span className="h-2 w-2 rounded-full bg-primary-content" />
						On-time inventory
					</div>
					</div>
