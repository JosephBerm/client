 ...
 *     await API.Accounts.changeStatus(userId, AccountStatus.Suspended, reason);
 *   }}
 ...
 */
export default function SuspendAccountModal({ isOpen, onClose, onConfirm, accountName }: SuspendAccountModalProps) {
			...
			<div className='p-6'>
				...
				<div className='flex items-start gap-3 mb-4'>
					...
					<div className='flex-1'>
						<h2 className='text-xl font-bold text-base-content'>Suspend Account</h2>
				...
				<div className='mb-6'>
					<label className='label'>
						...
						<span className='label-text-alt'>{remainingChars} chars remaining</span>
					</label>
					<FormTextArea
						value={reason}
					...
					<p className='text-xs text-base-content/50 mt-1'>
						This reason will be stored in the audit log and shown to the user. Minimum 5 characters
						required.
					</p>
				</div>
