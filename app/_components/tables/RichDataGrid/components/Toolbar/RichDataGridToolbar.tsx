			...
			<div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
				...
				{showSearch && (
					<div className="w-full sm:w-auto sm:max-w-xs flex-1 sm:flex-none">
						<GlobalSearchInput placeholder={searchPlaceholder} size="sm" />
					</div>
				)}
				...
				{activeFilterCount > 0 && (
					<div className="hidden sm:flex items-center gap-2">
						...
						<button
							...
							className="text-xs text-base-content/60 dark:text-base-content/50 hover:text-base-content dark:hover:text-base-content/80 underline"
						>
							Clear
						</button>
					</div>
