...
vi.mock('framer-motion', () => ({
  motion: {
    ...
    svg: React.forwardRef(({ children, ...props }: React.PropsWithChildren<Record<string, unknown>>, ref: React.Ref<SVGSVGElement>) => (
...
describe('RoleHierarchyDiagram Component', () => {
  ...
  describe('Empty State', () => {
    it('should handle empty roles array', () => {
      render(<RoleHierarchyDiagram {...defaultProps} roles={[]} />)
    ...
    it('should handle single role', () => {
      ...
      render(<RoleHierarchyDiagram {...defaultProps} roles={singleRole} />)
  ...
  describe('Interactions', () => {
    it('should call onRoleClick when role card is clicked', () => {
      ...
      render(<RoleHierarchyDiagram {...defaultProps} onRoleClick={onRoleClick} />)

      const roleCard = screen.getByText('Sales Manager').closest('[class*="cursor"]') ||
  ...
  describe('Edge Cases', () => {
    it('should handle roles with same level', () => {
      ...
      render(<RoleHierarchyDiagram {...defaultProps} roles={sameLevel} />)
    ...
    it('should handle very long role names', () => {
      ...
      render(<RoleHierarchyDiagram {...defaultProps} roles={longName} />)
    ...
    it('should handle roles with no permissions', () => {
      const noPermissions: RoleDefinitionDto[] = [
        createMockRole({ id: 1, permissions: [], userCount: 5 }),
      ]

      render(<RoleHierarchyDiagram {...defaultProps} roles={noPermissions} />)
    ...
    it('should handle many roles', () => {
      ...
      render(<RoleHierarchyDiagram {...defaultProps} roles={manyRoles} />)
