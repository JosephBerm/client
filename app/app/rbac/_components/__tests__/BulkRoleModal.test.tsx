...
function createMockUsersData(count: number = 4): PagedResult<UserWithRole> {
  const users: UserWithRole[] = [
    createMockUser({ id: 1, username: 'jdoe', email: 'user1@test.com', fullName: 'John Doe', role: AccountRole.SalesRep, roleDisplayName: 'Sales Representative' }),
    createMockUser({ id: 2, username: 'jsmith', email: 'user2@test.com', fullName: 'Jane Smith', role: AccountRole.SalesRep, roleDisplayName: 'Sales Representative' }),
    createMockUser({ id: 3, username: 'bwilson', email: 'user3@test.com', fullName: 'Bob Wilson', role: AccountRole.Customer, roleDisplayName: 'Customer' }),
    createMockUser({ id: 4, username: 'admin', email: 'admin@test.com', fullName: 'Admin User', role: AccountRole.Admin, roleDisplayName: 'Administrator' }),
  ].slice(0, count)
...
describe('BulkRoleModal Component', () => {
  const defaultProps = {
    ...
    onBulkUpdate: vi.fn().mockResolvedValue({ updatedCount: 2, failedCount: 0, failures: [] } as BulkRoleUpdateResult),
    onLoadUsers: vi.fn(),
  }
  ...
  describe('Modal Visibility', () => {
    ...
    it('should not render content when isOpen is false', () => {
      render(<BulkRoleModal {...defaultProps} isOpen={false} />)
  ...
  describe('User Display', () => {
    ...
    it('should show loading state when isLoadingUsers is true', () => {
      render(<BulkRoleModal {...defaultProps} isLoadingUsers={true} users={null} />)
    ...
    it('should show empty state when no users', () => {
      ...
      render(<BulkRoleModal {...defaultProps} users={emptyUsers} />)
      
      expect(screen.getByText(/no users/i)).toBeInTheDocument()
    })

    it('should call onLoadUsers when modal opens without users', () => {
      render(<BulkRoleModal {...defaultProps} users={null} />)
  ...
  describe('User Selection', () => {
    it('should allow clicking on user to select', async () => {
      ...
      const userRow = screen.getByText('John Doe').closest('div[class*="cursor"]') || 
  ...
  describe('Form Submission', () => {
    it('should call onBulkUpdate with correct parameters', async () => {
      ...
      render(<BulkRoleModal {...defaultProps} onBulkUpdate={onBulkUpdate} />)
    ...
    it('should show loading state during submission', async () => {
      const onBulkUpdate = vi.fn().mockImplementation(() => 
        new Promise(resolve => setTimeout(() => resolve({ updatedCount: 1, failedCount: 0, failures: [] }), 1000))
      )
  ...
  describe('Edge Cases', () => {
    it('should handle null users gracefully', () => {
      render(<BulkRoleModal {...defaultProps} users={null} isLoadingUsers={false} />)
    ...
    it('should handle single user', () => {
      ...
      render(<BulkRoleModal {...defaultProps} users={singleUser} />)
