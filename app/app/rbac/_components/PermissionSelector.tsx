	...
	return (
		<div className='space-y-4'>
			...
			<div className='flex items-center justify-between text-sm text-base-content/60'>
				...
				{searchTerm && (
					<span className='text-xs'>Showing {Object.values(filteredGroups).flat().length} results</span>
				)}
			</div>
			...
			<div className='space-y-2 max-h-[50vh] overflow-y-auto pr-2'>
				{Object.entries(filteredGroups).map(([resource, perms]) => {
					...
					const selectedInCategory = perms.filter((p) => selectedPermissionIds.includes(p.id)).length
							...
							<div
								...
								<div className='flex items-center gap-3'>
									...
									<Button
										...
										variant={categoryState === 'all' || categoryState === 'some' ? 'primary' : 'outline'}
										size='xs'
										className={`flex h-5 w-5 items-center justify-center rounded border-2 transition-colors p-0 ${
											categoryState === 'all'
										...
										return (
											<label
												...
												<Checkbox
													...
													className='checkbox-sm checkbox-primary mt-0.5'
												/>
				...
				{Object.keys(filteredGroups).length === 0 && searchTerm && (
					<div className='text-center py-8 text-base-content/60'>
						...
						<Button
							...
							variant='ghost'
							size='xs'
							className='text-primary text-sm mt-2 hover:underline h-auto p-0'>
							Clear search
						</Button>
					</div>
				)}
