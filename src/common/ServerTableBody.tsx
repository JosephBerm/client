...
import { TableProps, TableColumn, SearchTableProps } from '@/interfaces/Table'

import _ from 'lodash'

// Extend SearchTableProps

interface ActualProps<T> extends SearchTableProps<T> {
	data: any[]
}

function ServerTableBody<T>(props: ActualProps<T>) {
