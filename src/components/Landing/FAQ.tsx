	...
	return (
		<section className='faq-container'>
			...
			<p style={{ marginBottom: 50 }}>
				Find answers to frequently asked questions about our products, ordering process, shipping policies, and
				more. If you have a question, chances are it's answered here. If not, feel free to reach out to us
				directly.
			</p>
